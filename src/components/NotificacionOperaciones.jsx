    ...
    return (
        <ToastContainer position="top-center" className="p-2">
            <Toast
                ...
                show={visible} delay={2500} autohide bg={tipo === 'exito' ? 'success' : tipo === 'advertencia' ? 'warning' : 'danger'}
            >
                <Toast.Header>
                    <strong className="me-auto">{tipo === 'exito' ? '✅Exito' : tipo === '⚠️advertencia' ? 'Advertencia' : '❌Error'}</strong>
                </Toast.Header>
